    ...
    try:
        ...
        for word in email_content:
            if word in word_probs:
                log_spam_prob += math.log(word_probs[word]["spam_ratio"] + 1e-10)  # Add small value to avoid log(0)
...
if __name__ == "__main__":
    ...
    if args.info:
        dump_info("Enache-Stratulat_Marius", "Email_Classifier", "Marius_Chiar_El", "1.1", args.info)
        exit(1)
    ...
    test_emails_directory = "./Test/All" # Default path
